...
public class Employee extends Agent{
    ...
    public static void editEmployee(Connection connection,String id, String fullName, String phone, String address, String salary, String username, String password){
        try{
    ...
    public static void removeEmployee(Connection connection, String id){
        try{
